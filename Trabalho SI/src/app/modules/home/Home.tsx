    ...
    <div className="flex flex-col w-full gap-2 mt-auto">
      <div className="flex items-center justify-between p-1.5 border border-gray-200 rounded-lg bg-gray-50">
        <button 
          ...
          className=" bg-white border border-gray-300 text-gray-700 rounded-md h-7 w-7 flex items-center justify-center hover:bg-gray-100 transition font-bold shadow-sm"
        >
          -
        </button>
